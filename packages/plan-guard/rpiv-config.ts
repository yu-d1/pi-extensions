 ...
 *
 * NOTE: inlined into @liziy/plan-guard from @juicesharp/rpiv-config v2.6.0 (MIT)
 * to remove the external dependency. The original index.ts re-exports are merged
 * here — every export is defined in this single file.
 */
